...
def main(random_seeds,batch_size,X,y,epochs,lr_diff,lr_guide,start_t,end_T,num_classes,num_timesteps):
    acc_arr = []
    pre_arr = []
    f1_arr = []
    rec_arr = []
    for seed in random_seeds:
        ...
        optimizer = torch.optim.Adam(CARD.parameters(),lr=lr_diff,weight_decay=5e-4)
        aux_optimizer = torch.optim.Adam(guide_model.parameters(),lr=lr_guide,weight_decay=1e-3)
